...
const renderAnimalCard = (stats = {}) => {
  ...
  const selectAnimal = () => {
    if (animal == "sloth") {
      return `
      <svg preserveAspectRatio="xMidYMid meet" viewBox="-20 -20 112 112">
      ${animals.sloth}
      </svg>
      `;
    };
    ...
    if (animal == "horse") {
      return `
      <svg preserveAspectRatio="xMidYMid meet" viewBox="-30 -30 132 132">
      ${animals.horse}
      </svg>
      `;
    };
...
module.exports = renderAnimalCard;
